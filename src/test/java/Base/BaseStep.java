...
public class BaseStep {
    ...
    public void geturl()
    {
    driver.get("https://www.vakifbank.com");
    ...
    public void Assert(String path, Pather type,TimeOut timeOut, String strng) {

        Assert.assertEquals(strng, findElement(path,type,timeOut).getText());
